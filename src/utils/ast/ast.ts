// Imported from
// https://github.com/testing-library/eslint-plugin-testing-library/blob/main/lib/node-utils/index.ts
 ...
 * @param node
 * @param shouldRestrictInnerScope - If true, CallExpression must belong to
 * innermost scope of given node
 */
...
/**
 * Determines whether a given node belongs to handled Promise.all or
 * Promise.allSettled array expression.
 */
...
/**
 * Determines whether an Identifier related to a promise is considered as
 * handled.
 *
...
/**
 * Determines whether a given function node is considered as empty function or
 * not.
 *
...
/**
 * Finds the import specifier matching a given name for a given import module
 * node.
 */
